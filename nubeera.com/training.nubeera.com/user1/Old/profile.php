                       ...
                       <div class="tab-content profile-tab" id="myTabContent">
                           <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="home-tab">
                                       <div class="row">
                                           ...
                                           <div class="col-md-6">
                                                 <input type="text" spellcheck="false" class="text-primary input-weight"  placeholder="Update this Field" value="balsamleti" name="">
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-md-6">
                                           ...
                                           <div class="col-md-6">
                                                <input type="text" spellcheck="false" class="text-primary input-weight"  placeholder="Update this Field" value="Balchandra Samleti" name="">
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-md-6">
