      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Course Details</h1>
          </div>
...
<!-- Discount Price -->
              <div class="col-xl-6 col-md-6 mb-4">
                <div class="card shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                      <div class="form_material-group"><input class="form_material-input" value="5 %" type="text" ><span class="highlight"></span><span class="bar"></span><label class="text-xs font-weight-bold text-primary text-uppercase mb-1">Discount on Fee</label></div>
                      </div>
                      <div class="col-auto">
              ...
              <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                      <textarea rows="4" cols="100" placeholder="What you will learn Goes here"></textarea>
                    </div>
              </div>
              ...
              <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                      <textarea rows="4" cols="100" placeholder="Requirements for this Course goes here"></textarea>
                    </div>
              </div>
              ...
              <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                     <textarea rows="4" cols="100" placeholder="Who is this course for goes here"></textarea>
                    </div>
              </div>
