...
(1, 7, 'Basics', 'Shell and linux commad basics', 1);
...
(2, 1, 'Java', 'Java Basics', 0),
(4, 3, 'SparkTest', 'with active stat', 1),
(7, 7, 'Shell', 'Shell Scripting', 1),
(8, 2, 'ADTest', 'Test', 1);
...
(13, 'ABCD', 'ABCD', 0),
(14, 'Test', 'with active status', 1),
(15, 'Test', 'with not active status', 0);
...
INSERT INTO `topics` (`TopicId_PK`, `TChapId_FK`, `Topic_Description`, `mType`, `url`, `IsActive`) VALUES
(1, 1, 'Computer Language', 'video', 'https://youtu.be/TE6a8iB6e0k', 1);
...
--
ALTER TABLE `courses`
  MODIFY `CId_PK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
