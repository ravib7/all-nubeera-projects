               ...
               <ul id="myUL">
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           ...
                           <div class="panel-body">
                              ...
                              <pre>
                                 <ol>
                                    <li>class PySpark. SparkConf  (</li>
                                    <li>	loadDefaults = True,</li>
                                    <li>	_jvm = None,</li>
                                    <li	>_jconf = None</li>
                                    <li>)</li>
                                 </ol>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           ...
                           <pre>
                              1.def get(cls, filename):
                              2. path = os.path.join(SparkFiles.getRootDirectory(),filename)
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           ...
                           <div class="panel-body">
                              ...
                              <pre>
                                 <ol>
                                    <li>def getRootDirectory (cls):</li>
                                    <li>				if cls._is_running_on_worker:</li>
                                    <li>			return cls._root_directory</li>
                                    <li>		else:</li>
                                    <li>			# This will have to change if we support multiple SparkContexts:</li>
                                    <li>			return cls._sc._jvm.org.apache.spark.sparkfiles. getRootDirectory()</li>
                                 </ol>
                              </pre>
                           </div>
                        </div>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           ...
                           <div class="panel-body">
                              ...
                              <pre>
                                 <ol>
                                    <li>class MarshalSerializer (Framedserializer):</li>
                                    <li>	def dumps (self, obj):</li>
                                    <li>		return marshal .dumps (obj)</li>
                                    <li>	 def loads (self, obj):</li>
                                    <li>		return marshal. loads(obj)</li>
                                 </ol>
                              </pre>                          
							      </div>
                        </div>
                        ...
                        <div class="panel panel-primary">
                           ...
                           <div class="panel-body">
							 ...
							 speed.<br />
                              <pre>
                                 <ol>
                                    <li>class pickleserializer (FramedSerilizer):</li>
                                    <li>	def dumpa (self, obj):</li>
                                    <li>		return pickle .dumps(obj, protocol)</li>
                                    <li>	if sys.version >= '3':</li>
                                    <li>		def loads (self, obj, encoding=encoding)</li>
                                    <li>	else:</li>
                                    <li>		def loads (self, obj, encoding-None):</li>
                                 </ol>
                              </pre>
                           </div>
                        </div>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           ...
                           Status Trackers are Low-Level status reporting APIs which helps to monitor job and stage process.<br />
                              <pre>
                                 <ol>
                                    <li>def__init__(self, jtracker):</li>
                                    <li>		self._jtracker = jtracker</li>
                                 </ol>
                              </pre>
                           </div>
                        </div>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           ...
                           <div class="panel-body">
                              ...
                              <pre>
                                 <ol>
                                    <li>class SparkStageInfo(namedtuple("SparkStageInfo",</li>
                                    <li>								"stageId CurrentAttempt Id name numtasks numActiveTasks"</li>
                                    <li>								"numcompletedTasks numfailedeTasks")):</li>
                                 </ol>
                              </pre>
                           </div>
                        </div>
