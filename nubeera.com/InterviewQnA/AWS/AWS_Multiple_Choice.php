            ...
            <div class="col-lg-12">
               ...
               <ul id="myUL">
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              3) As a web developer, you are developing an app, targeted especially for the mobile platform. 
                                 Which of the following lets you add user sign-up, sign-in, and access control to your web and mobile apps quickly and easily?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              4) You are a Machine Learning Engineer who is on the lookout for a solution that will discover sensitive information that your enterprise stores in AWS and 
                                 then use NLP to classify the data and provide business-related insights. Which among the services would you choose?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              9) This service is used to make it easy to deploy, manage, and scale containerized applications using Kubernetes on AWS.
                                 Which of the following is this AWS service?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                                    <b>Amazon Elastic Container Service</b>
                                 </li>
                                 <li>
                                    AWS Batch
                                 </li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              11)  As an AWS Developer, using this pay-per-use service, you can send, store and receive messages between software components.
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              12) Which service do you use if you would like to host real-time audio and video conferencing application on AWS,
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              14) You are a Machine Learning engineer and you are looking for a service that helps you build and
                                    train Machine Learning models in AWS. Which among the following are we referring to?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              15)  Imagine that you are working for your company's IT team. 
                                 You are assigned to adjusting the capacity of AWS resources based on the incoming application and network traffic. 
                                 How would you do it?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 ...
                                 <li>
                                    <b>Amazon Elastic Load Balancing</b>
                                 </li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              16) This cross-platform video game development engine that supports PC, Xbox, Playstation, iOS, and 
                                 Android platforms allows developers to build and host their games on Amazon's servers.
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              17) You are the Project Manager of your company's Cloud Architects team. 
                                 You are required to visualize, understand and manage your AWS costs and usage over time. 
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              18) You are the chief Cloud Architect at your company. How can you automatically monitor and adjust computer resources
                                    to ensure maximum performance and efficiency of all scalable resources?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              19) As a database administrator. you will employ a service that is used to set up and manage databases such as MySQL, MariaDB, and 
                                 PostgreSQL. Which service are we referring to?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                  ...
                  <li><a href="#">
                        <div class="panel panel-primary">
                           <div class="panel-heading">
                              20) A part of your marketing work requires you to push messages onto Google, Facebook, Windows, and 
                                 Apple through APIs or AWS Management Console. Which of the following services do you use?
                           </div>
                           <div class="panel-body">                          
                              <ol>
                                 <li>
                                 ...
                                 <li>
                                    <b>AWS Simple Notification Service</b>
                                 </li>
